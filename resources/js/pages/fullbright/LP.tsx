...
export default function LandingPage({
    ...
    const [mode, setMode] = useState<PricingMode>(initialPricingMode);
    ...
    const waDismissedRef = useRef(false);
    ...
    useEffect(() => {
        ...
        const open = (): void => {
            if (!waDismissedRef.current) {
                setWaBubbleOpen(true);
            }
        };
    ...
    return (
        <>
            <Head title="Kelas TOEFL Skor 500+ untuk Submission Beasiswa dan Kerja">
                <meta
                    name="description"
                    content="Persiapkan TOEFL 500+ dalam 15 hari dengan metode belajar terstruktur dari Full Bright Indonesia. Mulai dari Rp99rb."
                />
            </Head>
            <style>{KEYFRAMES}</style>

            <div className="fullbright-page [min-height:100vh] [font-family:Nunito,system-ui,sans-serif] [background:#fff]">
                {/* Urgency Banner */}
                {flashVisible ? (
                    <>
                        <TrackedCTA
                            zone="sticky"
                            action="scroll"
                            label="🔥 FLASH SALE SEPTEMBER · DISKON 60% 🔥 FLASH SALE SEPTEMBER · 60% ⏱ Berakhir {countdown}"
                            ref={bannerRef}
                            id="urgency-banner"
                            href="#pricing"
                    ...
                    <div className="[overflow:hidden] [mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)] [-webkit-mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)]">
                        <div className="[display:flex] [width:max-content] [animation:infiniteScroll_30s_linear_infinite]">
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage: "url('/assets/unair.png')",
                                }}
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage:
                                        "url('https://www.unpad.ac.id/wp-content/uploads/2025/12/logo-unpad-duo.svg')",
                                }}
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage:
                                        "url('/assets/logos/nottingham.png')",
                                }}
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage:
                                        "url('/assets/logos/stuttgart.png')",
                                }}
                                className="[margin:0_20px] [height:64px] [width:110px] [flex-shrink:0] [background-size:contain] [background-position:center] [background-repeat:no-repeat]"
                            ></div>
                        ...
                        <div className="[margin-bottom:32px] [overflow:hidden] [border-radius:20px] [box-shadow:0_4px_24px_rgba(0,0,0,0.07)] [background:#fff]">
                            ...
                            <div className="[display:grid] [grid-template-columns:1fr_1fr] [align-items:stretch] [border-bottom:1px_solid_#f2f2f2] max-[559px]:[grid-template-columns:1fr]">
                                <div className="[display:flex] [align-items:flex-start] [gap:12px] [padding:18px] max-[559px]:[padding:16px_16px_10px]">
                                    <span className="[flex-shrink:0] [font-size:12px] [font-weight:900] [font-family:Nunito,sans-serif] [color:#6b7280] [padding-top:2px]">
                                        01
                                    </span>
                ...
                <section
                    id="proof"
                    className="[background:#fff] [padding:72px_24px]"
                >
                    <div className="[margin:0_auto] [max-width:672px]">
                        ...
                        <div className="[margin:0_auto_32px] [display:flex] [max-width:420px] [flex-direction:column]">
                            ...
                            >
                                ...
                                <div
                                    style={{
                                        backgroundImage:
                                            "url('/assets/toefl1.webp')",
                                    }}
                                    className="[border-radius:14px] [box-shadow:0_6px_24px_rgba(0,0,0,0.18)] [aspect-ratio:1/1] [width:100%] [overflow:hidden] [background-size:cover] [background-position:center]"
                                ></div>
                            </div>
                ...
                >
                    <div className="[margin:0_auto] [max-width:1152px]">
                        ...
                        <div className="[margin:0_auto_44px] [max-width:840px]">
                            <div className="[position:relative] [aspect-ratio:16/9] [overflow:hidden] [border-radius:20px] [box-shadow:0_8px_32px_rgba(0,0,0,0.12)] [background:#151515] [border:1px_solid_#e5e5e5]">
                                <video
                                    controls
                                    preload="metadata"
                                    className="[display:block] [height:100%] [width:100%] [object-fit:cover]"
                                >
                            ...
                            <div className="[display:grid] [grid-template-columns:1.35fr_1fr] [align-items:stretch] [overflow:hidden] [border-radius:22px] [box-shadow:0_4px_22px_rgba(0,0,0,0.06)] [background:#fff] [border:1px_solid_#ececec] max-[899px]:[grid-template-columns:1fr]">
                                ...
                                <div className="[display:flex] [flex-direction:column] [justify-content:center] [gap:11px] [padding:24px_26px]">
                                    <div className="[display:flex] [flex-wrap:wrap] [align-items:center] [gap:10px]">
                                        ...
                                        <span className="[font-size:11px] [font-weight:900] [letter-spacing:0.08em] [text-transform:uppercase] [color:#6b7280]">
                                            Diagnostic Test
                                        </span>
                                        <span className="[display:inline-flex] [align-items:baseline] [gap:5px] [border-radius:9999px] [padding:6px_13px] [font-family:Nunito,sans-serif] [font-size:15px] [font-weight:900] [white-space:nowrap] [color:#D70808] [background:#FFF0F0] [border:1.5px_solid_#ffb3b3]">
                                            <span className="[font-size:10px] [font-weight:900] [letter-spacing:0.06em] [text-transform:uppercase] [color:#D70808]">
                                                Senilai
                                            </span>
                                            Rp 120.000
                                        </span>
                        ...
                        <div className="[margin:0_auto_44px] [max-width:560px] [border-radius:22px] [padding:26px_24px] [text-align:center] [box-shadow:0_4px_22px_rgba(0,0,0,0.06)] [background:#fff] [border:1.5px_solid_#ffd6d6]">
                            <p className="[margin:0_0_8px] [font-size:12px] [font-weight:900] [letter-spacing:0.08em] [text-transform:uppercase] [color:#6b7280]">
                                Total nilai semua fitur di atas
                            </p>
                            <p className="[margin:0_0_12px] [font-size:clamp(30px,5vw,40px)] [line-height:1] [font-weight:900] [font-family:Nunito,sans-serif] [color:#6b7280] [text-decoration:line-through] [text-decoration-color:#D70808] [text-decoration-thickness:3px]">
                                Rp 1.005.000
                            </p>
                    ...
                    <div className="[padding:80px_24px] [background:#fff]">
                        <div className="[margin:0_auto] [max-width:1152px]">
                            ...
                            <div className="[margin:0_auto_56px] [width:100%] [max-width:896px]">
                                <p className="[margin:0_0_24px] [text-align:center] [font-size:12px] [font-weight:700] [letter-spacing:0.08em] [text-transform:uppercase] [color:#6b7280]">
                            ...
                            <div className="[margin-top:48px]">
                                ...
                                <div className="[position:relative] [display:flex] [height:220px] [align-items:center] [justify-content:center] [overflow:hidden]">
                                    ...
                                    <img
                                        ...
                                        alt="Ulasan alumni Full Bright Indonesia"
                                    />
                                    <div
                            ...
                            <div className="[margin-top:48px] [margin-right:auto] [margin-left:auto] [max-width:520px]">
                                <p className="[margin:0_0_6px] [text-align:center] [font-size:11px] [font-weight:900] [letter-spacing:0.08em] [text-transform:uppercase] [color:#6b7280]">
                                    Cerita Alumni
                                </p>
                ...
                {lightboxIdx !== null ? (
                    <>
                        <div
                            role="dialog"
                            aria-modal="true"
                            aria-label="Galeri alumni"
                            className="[position:fixed] [inset:0] [z-index:100] [display:flex] [align-items:center] [justify-content:center] [background:rgba(0,0,0,0.92)]"
                        ...
                        >
                            <div className="[margin:0_auto] [max-width:1152px]">
                                <div className="[margin-bottom:32px] [text-align:center]">
                                    ...
                                    <p className="[margin:0] [font-size:16px] [max-width:512px] [margin-left:auto] [margin-right:auto] [line-height:1.6] [color:#3d3d3d]">
                                        <b>
                                ...
                                <div className="[margin-bottom:44px] [text-align:center]">
                                    ...
                                    <div className="[display:inline-flex] [gap:4px] [border-radius:9999px] [padding:5px] [box-shadow:0_2px_12px_rgba(215,8,8,0.08)] [background:#fff] [border:1px_solid_#ffb3b3]">
                                        ...
                                        >
                                            Dibimbing Tutor
                                            <span className="[position:absolute] [top:-9px] [right:-6px] [display:flex] [align-items:center] [justify-content:center] [width:34px] [height:34px] [border-radius:9999px] [font-size:11px] [font-weight:900] [background:#F97316] [color:#151515] [border:2px_solid_#fff] [box-shadow:0_2px_8px_rgba(249,115,22,0.4)]">
                                                -80%
                                            </span>
                                        </button>
                                    </div>
                                ...
                                <div className="[margin:0_auto_40px] [max-width:520px]">
                                    <div className="[position:relative] [display:flex] [flex-direction:column] [overflow:hidden] [border-radius:24px] [padding:28px] [box-shadow:0_8px_32px_rgba(245,183,0,0.15)] [background:linear-gradient(165deg,#ffffff_0%,#fffbf0_100%)] [border:2px_solid_#F5B700]">
                                        <div className="[position:absolute] [top:0] [right:0] [font-size:12px] [font-weight:900] [padding:8px_16px] [border-bottom-left-radius:16px] [color:#151515] [background:#F5B700] [font-family:Nunito,sans-serif]">
                                            🔥 POPULAR
                                        </div>
                                        ...
                                        <div className="[margin-bottom:20px] [border-radius:16px] [padding:16px] [background:#FFF0F0] [border:1.5px_solid_#ffb3b3]">
                                            <div className="[margin-bottom:4px] [display:flex] [align-items:center] [gap:8px]">
                                                <span className="[font-size:14px] [font-weight:700] [color:#64748b] [text-decoration:line-through]">
                                                    Rp 250.000
                                                </span>
                                ...
                                <div className="[margin:0_auto_32px] [max-width:520px]">
                                    <p className="[margin:0_0_16px] [text-align:center] [font-size:13px] [font-weight:800] [letter-spacing:0.06em] [text-transform:uppercase] [color:#6b7280]">
                ...
                >
                    <div className="[margin:0_auto] [max-width:460px] [border-radius:16px] [padding:20px_20px_16px] [background:#FAFAFA] [border:1px_solid_#ececec]">
                        <div className="[margin-bottom:16px]">
                            <p className="[margin:0_0_6px] [font-size:11px] [font-weight:700] [letter-spacing:0.06em] [text-transform:uppercase] [color:#6b6b6b]">
                                BOLEH TAHU KESULITANMU?
                            </p>
                            <h2 className="[margin:0] [font-size:clamp(20px,3.6vw,23px)] [line-height:1.25] [font-weight:800] [font-family:Nunito,sans-serif] [color:#151515]">
                ...
                {/* Floating WhatsApp */}
                <div className="[position:fixed] [right:40px] [bottom:20px] [z-index:52] [display:flex] [flex-direction:column] [align-items:flex-end] [gap:10px] max-[559px]:[right:20px]">
                    {waBubbleOpen ? (
                        <>
                            <div className="[position:relative] [max-width:270px] [border-radius:18px_18px_6px_18px] [padding:14px_16px_14px_14px] [box-shadow:0_10px_34px_rgba(0,0,0,0.18)] [background:#fff] [border:1px_solid_#e5e7eb] max-[559px]:[max-width:208px] max-[559px]:[border-radius:14px_14px_5px_14px] max-[559px]:[padding:10px_12px_10px_11px]">
                                ...
                                <TrackedCTA
                                    zone="floating"
                                    action="whatsapp"
                                    label="Ms. Fini - Admin Full Bright Masih bingung atau ragu? Tanya langsung ke saya di WA ☕ Balas sekarang →"
